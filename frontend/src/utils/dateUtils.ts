 ...
 * @param baseDate Optional date to use for the conversion (defaults to today)
 */
export const localTimeToUtc = (
  ...
  try {
    ...
    // Use provided base date or create a new one
 ...
 * @param utcTimeStr Time string in HH:MM format
 * @param baseDate Optional date to use for the conversion (defaults to today)
 */
