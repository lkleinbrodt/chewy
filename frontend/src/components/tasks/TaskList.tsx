...
const TaskList = ({
  ...
  // Handle different empty states based on context
  if (
    tasks.length === 0 &&
  ...
  // Handle case where there are no tasks but there are recurring events
  if (tasks.length === 0 && showRecurringEvents && recurringEvents.length > 0) {
    return (
      <Table>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          ...
          <TableRow>
            <TableCell colSpan={5} className="text-center py-8 text-gray-500">
              ...
              <div className="text-xs mt-1">Create a task to see it here.</div>
            </TableCell>
          </TableRow>

          {/* Divider for Recurring Events Section */}
          <TableRow className="bg-gray-100">
            <TableCell colSpan={5} className="text-center py-4">
              <div className="flex items-center justify-center">
                <div className="flex-1 border-t border-gray-300"></div>
                <span className="px-4 text-sm font-medium text-gray-600 bg-gray-100">
                  Recurring Events
                </span>
                <div className="flex-1 border-t border-gray-300"></div>
              </div>
  ...
  // Handle case where there are tasks but no recurring events
  if (tasks.length > 0 && showRecurringEvents && recurringEvents.length === 0) {
    return (
      <Table>
        <TableHeader>
        ...
        <TableBody>
          ...
          {/* Empty recurring events section */}
          <TableRow className="bg-gray-100">
            <TableCell colSpan={5} className="text-center py-4">
              <div className="flex items-center justify-center">
                <div className="flex-1 border-t border-gray-300"></div>
          ...
          <TableRow>
            <TableCell colSpan={5} className="text-center py-8 text-gray-500">
              <div className="text-sm">No recurring events created yet.</div>
              <div className="text-xs mt-1">
                Create a recurring event to see it here.
              </div>
            </TableCell>
          </TableRow>
        </TableBody>
  ...
  return (
    <Table>
      ...
      <TableBody>
        ...
        {/* Divider for Recurring Events Section */}
        {showRecurringEvents && sortedRecurringEvents.length > 0 && (
          <TableRow className="bg-gray-100">
            <TableCell colSpan={5} className="text-center py-4">
              <div className="flex items-center justify-center">
                <div className="flex-1 border-t border-gray-300"></div>
