...
# from backend.models import User  # User model is not currently used in Chewbacca
...
def apple_signin(apple_credential):
    ...
    # User model is not currently used in Chewbacca
    # user = None
    #
    ...
    #
    # return user
    return None  # User functionality is not currently implemented
